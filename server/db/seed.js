...
for(let i = 0; i <= 100; i++){
  let testQuery = `INSERT INTO listings (roomname, room_location, room_img, price, stars, reviews_num, liked, room__host_name, about_room, about_space, about_neighborhood) VALUES ('${faker.name.title()}', '${faker.address.city()}', 'three', 4, 5, 6, 1, '${faker.name.firstName()}', 'nine', 'ten', 'eleven')`;
